...
var DOMAIN = "knighter.cn";
var MINAPPTYPE="0";//小程序的类型，如果是企业小程序请填：0 ，如果是个人小程序请填：1
var WEBSITENAME="cStoryBooks"; //网站名称
...
var ZANIMAGEURL = 'http://knighter.cn/wp-content/uploads/2018/04/WechatIMG3-e1524223858230.jpeg';//微信赞赏的图片链接，用于个人小程序的赞赏
...
var DOWNLOADFILEDOMAIN = [
    { id: 1, domain: 'https://knighter.cn' },
    { id: 2, domain: 'https://knighter.cn' },
    { id: 3, domain: 'https://knighter.cn' }
]
 //首页图标导航
...
var INDEXNAV = [
  { id: '1', name: '素材店', image: '../../images/shop.png', url: 'pages/shelf/shelf', redirecttype: 'miniapp', appid: 'wx764fa42b23cd341f', extraData:'' },
    { id: '2', name: '排行榜', image: '../../images/ranking.png', url: '../hot/hot', redirecttype: 'apppage', appid: '', extraData:''},   
    ]
