...
declare module ls {
    ...
    class EventSheetDecoder {
         ...
         * 并且条件属性中可能会有组
         */
        static decodeConditionProperties(conditionInstance: BaseEvent): BaseEvent;
...
declare module ls {
    class AIDisplayObject extends AIObject {
        ...
        private _updateAnchorOffsetX;
        private _updateAnchorOffsetY;
...
declare module ls {
    ...
    class Trigger {
        ...
        static compareParam(condition: Condition, compareData: any): boolean;
